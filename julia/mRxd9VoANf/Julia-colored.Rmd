...
exp <- 7 # exponent of the function
ind <- 0.4668 # independent term of the function
ite <- 6 # number of iterations

# Pick a top palette from COLOURLovers  
pal <- clpalette(359978) %>% swatch %>% .[[1]] %>% unique() %>% colorRampPalette()
